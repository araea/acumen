...
set -euo pipefail
cd -- "$(dirname -- "$0")/.."
export CARD_ARTIFACTS="${CARD_ARTIFACTS:-${TMPDIR:-/tmp}/ayjx-cards}"
...
export PORTRAIT_CARD_DUMP="$CARD_ARTIFACTS/portrait"
...
export AYJX_CHART_PREVIEW="$STATS_CARD_DUMP/types.png"
