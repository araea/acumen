...
register_plugins!(
    ...
    oai {
        ...
        commands: cmds![
            ...
            (
                "##<名称> agent",
                "建一间内置智能体房间；模型与工具由 [oai] 配置"
            ),
            ("oai <API地址> <密钥>", "配置模型接口"),
            ("##<名称>(<描述>) <模型> <提示词>", "创建智能体"),
            ("<名称> <内容>", "与智能体对话；名称前加 ~ 为临时对话"),
            (
                "画·<预设> <描述/图片>",
                "内置画图预设房间；全部预设见 /# 的「画图预设」分区"
            ),
            ("<名称>!", "停止智能体回复"),
            ("-#<名称>", "删除智能体"),
            ("<名称>~#<新名>", "复制智能体"),
    ...
    ai_news {
        ...
        commands: cmds![
            ...
            ("ai日报", "最新一期 AI 日报"),
            (
                "ai模型排行榜 / ai模型榜 / 模型排行榜 / 模型榜 [编程|推理|知识|专业办公]",
                "AIHOT 大模型排行榜：共识指数、评测证据与官网参考价，可按能力分类看"
            ),
            ...
            (
                "ctl set ai_news card_theme auto",
